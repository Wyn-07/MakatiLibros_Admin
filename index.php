        ...
        <div class="container-body-login">
            <div class="transparent">
                <div class="container-white-login">
                    ...
                    <form action="admin/dashboard.php" method="POST" enctype="multipart/form-data" id="form" onsubmit="return validateForm()">
                    ...
                    <div class="row-center">
                        <a href="admin/register.php" class="login-link font-14px">Register</a>
                        <a href="admin/reset.php" class="login-link  font-14px ">Reset Password</a>
                    </div>
